    ...
    <body>
        <div class="container-fluid main_content_table_cell full_expand smooth_transform" id="side_bench_media_player" style="padding: 0px; width: 25%; height: 100%; background: var(--alpha70color10);">
            <div class="row no_gutter" style="height: 10vh; position: relative;">
                <div class="media_player full_expand" id="media_player_UI" style="display: block; opacity: 1; animation: fadein 0.4s;">
                    ...
                    <div class="col-md-10 full_expand song_item" id="playing_song">
                        <p class="song_name" id="playing_song_name">No.9 Sonata Seg.2nd</p>
                        <hr>
                        <p class="song_musician" id="playing_song_musician">J.S Bach</p>
                    </div>
                </div>
