<%-- 
    Document   : UserUpload
    Created on : Jun 1, 2017, 5:34:13 PM
    Author     : ngoct
--%>
                                ...
                                <div class="panel panel-default panel-table">
                                    <div class="panel-heading">
                                        <div class="row text-center">
                                            <h1 class="page-title">${song != null? 'Edit Song':'Upload Song'}</h1>
                                        </div>
                                    </div>
                                <div class="panel-body">
                                    <div class="col-md-8 col-md-offset-2">
                                    <html:form action="upload" method="post" enctype="multipart/form-data" onsubmit="return validateSong()">
